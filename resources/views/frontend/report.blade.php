...
@section('style')
{{ Html::style(('public/AdminLTE-2.4.2/bower_components/jvectormap/jquery-jvectormap.css')) }}
@endsection
@section('content')
...
@section('script')
	<!-- Sparkline -->
	{{ Html::script(('public/AdminLTE-2.4.2/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js')) }}
	<!-- jvectormap  -->
	...
	<!-- ChartJS -->
	{{ Html::script(('public/AdminLTE-2.4.2/bower_components/chart.js/Chart.js')) }}
