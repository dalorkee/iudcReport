...
<h1>จำนวนประชากรจำแนกตามอายุและเพศ <small>รายจังหวัด</small></h1>
<ol class="breadcrumb">
	...
	<li><a href="{{ route('export-population.sex-age-province') }}" class="active">จำนวนประชากรจำแนกตามอายุและเพศรายจังหวัด</a></li>
</ol>
</section>
<!-- Main content -->
		...
		<div class="col-md-6">
			...
			<div class="box box-info">
				<div class="box-header with-border">
					<h3 class="box-title">ส่งออกข้อมูล(XLS) - จำนวนประชากรจำแนกตามอายุและเพศ <small>รายจังหวัด</small></h3>
				</div>
				<div class="box-body">
				<form action='{{ route('post_sex-age-province') }}' class="form-horizontal" method="post">
					{{ csrf_field() }}
					<div class="box-body">
